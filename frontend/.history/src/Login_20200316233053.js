      ...
      return (
        <div style={{ background: "#0b1a26" }}/>
            ...
            <StyleRoot>
              ...
              <Card style={{ disply: "flex",alignItems:"center",justifyContent:"center", maxWidth: "400px", maxHeight: "400px", padding: "7px", backgroundColor: "RGB(0, 0, 0,0.5)", borderRadius: "50px" }}>
