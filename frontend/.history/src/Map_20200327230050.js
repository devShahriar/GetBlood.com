  ...
  get=()=>{
    try{
      Axios({
         ...
         this.setState({res:response.data.token})
    ...
    return (
       <div  className="content" onClick={()=> {
        ...
        navigator.geolocation.getCurrentPosition(position => {
          ...
          directions.setDestination([d.longitude,d.latitude]);
            ...
            location: {d.location}
            <Divider/>
            <Label color="violet" pointing='left'>👈 click here to get directions</Label>
            <Divider/>
       </div>
      ...
      return (
        <div >
          ...
          <Button inverted color="violet" onClick={{ this.getToken}}> Send notification to donor</Button>
        </div>
        );
