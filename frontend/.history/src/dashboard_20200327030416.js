    ...
    //    else{
            ...
            return (
               <div key={idx} className="content">
                    {d.name}
                    {idx}
                    <Button key={idx} inverted color="violet" onClick={()=>lantitude=d.lantitude,logitude=d.logitude}>get direction</Button>
                    <Divider/>
               </div>
           ...
           <Map ref='map' lantitude={lantitude} logitude={logitude}/>
          </div>);
      //  }
