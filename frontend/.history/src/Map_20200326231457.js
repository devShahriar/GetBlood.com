  ...
  render() {
   ...
   // }else{
    ...
    //  localStorage.removeItem("token")
      return (
        <div >
          <div ref={el => this.mapContainer = el} style={{ width: "100vw", height: "100vh" }} className="map" >
            <Button zDepth={10} outline color="danger" onClick={this.ha}>Get direction</Button>
          </div>
        </div>
        );
    //}
