              ...
              <Card  >
               ...
               <CardHeader>Login</CardHeader>
                <CardBody >
                  ...
                  <br></br>
                  <FormInput style={{ backgroundColor:"rgb(0,0,0)" ,borderColor:this.state.userValid?'black':'red'}} type="password"   placeholder={this.state.userValid?"password":"invalid password"} value={this.state.password} onChange={this.onChange} name="password" />
                  <br></br>
