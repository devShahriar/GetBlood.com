  ...
  render() {
    ...
    return (
      <div className="donar-signup">
        ...
        />
        {this.state.notification_granted?alert('you will now receive notification'):
            
        
            setTimeout(function(){ <Label pointing="left">you must enable notification
            in order to signup</Label> }, 1000)}
      </div>
    );
  }
}
