    ...
    //    else{
            ...
            return (
               <div key={idx} className="content">
                    {d.name}
                    {idx}
                    <Button key={idx} inverted color="violet" onClick={this.setState(()=>{this.state.lang=d.lantitude,this.state.long=d.logitude})}>get direction</Button>
                    <Divider/>
               </div>
           ...
           <Map ref='map' lantitude={this.state.lang} logitude={this.state.long}/>
          </div>);
      //  }
