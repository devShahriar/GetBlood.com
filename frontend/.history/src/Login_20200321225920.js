              ...
              <Card  >
               ...
               <CardHeader style={{color:'white',marginLeft:'10px',fontSize:'15px',fontStyle: 'italic'}}>Login</CardHeader>
                <CardBody >
                  ...
                  <FormInput style={{borderRadius:'8.5px', borderColor:"#046b85", backgroundColor:"rgb(0,0,0)",padding:'52px'}}  type="text" placeholder="username" value={this.state.name} onChange={this.onChange} name="name" />
                  <br></br>
