              ...
              <Card  >
               ...
               <CardHeader>Login</CardHeader>
                <CardBody >
                  ...
                  <FormInput style={{ backgroundColor:"rgb(0,0,0)"}}  type="text" placeholder="username" value={this.state.name} onChange={this.onChange} name="name" />
                  <br></br>
                  <FormInput style={{ backgroundColor:"rgb(0,0,0)"}}  type="text" placeholder="email" value={this.state.email} onChange={this.onChange} name="email" />
                  <br></br>
