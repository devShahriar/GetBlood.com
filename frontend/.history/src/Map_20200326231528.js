  ...
  render() {
   ...
   // }else{
    ...
    //  localStorage.removeItem("token")
      return (
        <div >
          <div zDepth={1} ref={el => this.mapContainer = el} style={{ width: "100vw", height: "100vh" }} className="map" >
            <Button zDepth={2} outline color="danger" onClick={this.ha}>Get direction</Button>
          </div>
        </div>
        );
    //}
