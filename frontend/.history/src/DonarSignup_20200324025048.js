  ...
  notifyMe=()=>{
      this.setState({checked:true})
        Notification.requestPermission().then(function(permission) {
            ...
            if(err){
                this.setState({notification_granted:"not"})
            }
        })
  ...
  render() {
    ...
    return (
      <div className="donar-signup">
        ...
        />
        {this.state.checked?this.state.notification_granted==='granted'?alert('you will now receive notification'):<Label pointing="left">you must enable notification
            in order to signup</Label>:null}
