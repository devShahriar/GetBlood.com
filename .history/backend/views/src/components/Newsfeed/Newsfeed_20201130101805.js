    ...
    return (
      <div style={{ backgroundColor:'black'}}>
        <div className="navbar" style={{ backgroundColor:'black'}}>
          <div className="logbutton" style={{ backgroundColor:'black'}}>
        ...
        <div className="w modal" style={ this.state.isLoggedIn ? { display:'block'} : {display : 'none'} }>
          <LoginModal />
        ...
        <div className="feed" style={{ backgroundColor:'black' , width:'cover'}}>
          <ul>{post}</ul>
        </div>
