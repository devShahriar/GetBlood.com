...
let logitude =null
  ...
  ha=()=> {
    ...
    navigator.geolocation.getCurrentPosition(position => {
      ...
      this.directions.setDestination([90.421012,23.748993]);
    })
  ...
  render() {
   ...
   // }else{
    ...
    return (
       <div key={idx} className="content" onClick={this.ha.bind(this)}>
            {d.name}
            {idx}
      ...
      return (
        <div >
            ...
            autoFocus/>
              ...
              <div>
              {list}
              <Button  inverted color="pink" onClick={this.ha}>search</Button>
              </div>
            </div>
