              ...
              <Card  >
               ...
               <CardHeader>Login</CardHeader>
                <CardBody>
                  ...
                  <FormInput className="form"  type="text" placeholder="username" value={this.state.name} onChange={this.onChange} name="name" />
                  <br></br>
                  <FormInput className="form"  type="text" placeholder="email" value={this.state.email} onChange={this.onChange} name="email" />
                  <br></br>
                  <FormInput className="form"  style={{borderColor:this.state.userValid?'black':'red'}} type="password"   placeholder={this.state.userValid?"password":"invalid password"} value={this.state.password} onChange={this.onChange} name="password" />
                  <br></br>
