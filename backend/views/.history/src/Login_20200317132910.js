...
export default class Login extends React.Component {
  ...
  render() {
    ...
    if (this.state.loggedIn === true) {
      ...
      return (
        <div style={{backgroundImage:`url(${home})`,width:'100%',height:'auto' }}>
         
        
            <StyleRoot>
              <div style={styles.bounceInLeft }>
              <Card style={{ maxWidth: "400px", maxHeight: "400px", paddingBottom:'200px', backgroundColor: "RGB(0, 0, 0,0.5)", borderRadius: "50px" }}>
