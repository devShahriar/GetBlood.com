...
export default class Login extends React.Component {
  ...
  render() {
    ...
    if (this.state.loggedIn === true) {
      ...
      return (
        <div style={{backgroundImage:`url(${home})`,backgroundSize:'1200px', height:'100%'}}>
         
        
            <StyleRoot>
              <div style={styles.bounceInLeft }>
              <Card style={{ maxWidth: "300px", maxHeight: "400px", padding: "7px", backgroundColor: "RGB(0, 0, 0,0.5)", borderRadius: "50px" }}>
