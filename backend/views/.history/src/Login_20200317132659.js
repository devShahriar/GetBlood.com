...
export default class Login extends React.Component {
  ...
  render() {
    ...
    if (this.state.loggedIn === true) {
      ...
      return (
        <div style={{ paddingTop:"200px",paddingLeft:"400px" ,paddingBottom:'auto',margin:'auto',backgroundImage:`url(${home})` }}>
         
        
            <StyleRoot>
              <div style={styles.bounceInLeft }>
              <Card style={{ maxWidth: "400px", maxHeight: "400px", padding: "7px", backgroundColor: "RGB(0, 0, 0,0.5)", borderRadius: "50px" }}>
               <CardHeader>Login</CardHeader>
                <CardBody>
                  <form onSubmit={this.formSubmit} style={{backgroundImage:`url(${home})`}}>
